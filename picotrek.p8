...
-- HAL, MAP, POW, WEP, HAX
--instructions = split("\^|00⬆️⬇️⬅️➡️;⬅️➡️ steer\n⬆️⬇️ thruster;⬆️⬇️⬅️➡️ cursor\n❎ pick;⬆️⬇️ weapon select\n⬅️➡️ change angle(phaser)\n❎ fire (phaser)\n❎ lock on target (mgun)⬆️⬇️⬅️➡️ cursor\n❎ lock (feed)\n❎ use hack",";")

--function draw_inst(i,y)
    --print(instructions[i],0,y,7)
--end
...
function hal_draw(player)
    local y = player_ui_y(player)
    local positions = {{48,2},{48,34},{2,18},{94,18}}
    for i = 1,4 do
        local n = positions[i]
        spr(188 + i * 4, n[1], y + n[2], 4, 3)
    end
    rectfill(59,25 + y,68,34 + y,0)
    rect(58,24 + y,69,35 + y,7)
    spr(91 + player, 60,26 + y)
...
function map_draw(player)
    ...
    -- Draw our ship
    local sp = {
        angle2vec(playership.angle) * 5.5,
        angle2vec(0.625 + playership.angle) * 3.5,
        angle2vec(0.375 + playership.angle) * 3.5,
    }
    ...
    for p = 1,2 do
        local ps = playership.map['p'..p..'steer']
        local pt = playership.map['p'..p..'thrust']
        if ps < 0 then
...
function _draw()
    ...
    if not started then
        for i = 1,2 do
            spr(91 + i, 60, 18 + player_ui_y(i))
            print("press 🅾️ to start", 32, 32 + player_ui_y(i), 5 + time() % 2)
        end   
    ...
    -- Player screens
    for i = 1,2 do
        if playership.dead then camera(-playership.dead_time * 10 * (i - 1.5)*2, 0) end
    ...
    if playership.dead then
        ...
        msg = "you died"
        if playership.dead_time > 30 then cls(); camera() end
    ...
    if count_hostiles() == 0 then
        ...
        if win_time == 0 then
            ...
            persistent.hull = playership.hull
        ...
        for i = 1,2 do
            rect(0, player_ui_y(i), 127, player_ui_y(i) + screen_height-1, playercolors[i])
            print(sub(msg, 0, win_time \ 2), 4, 4 + player_ui_y(i), 6)
        end
        
        if win_time > (240 + #msg\2) and level < 5 then level += 1; init_level() end
    end

    --if curbtn != nil then print(curbtn,100,40,12) end
end
__gfx__
...

...

...

...

...

